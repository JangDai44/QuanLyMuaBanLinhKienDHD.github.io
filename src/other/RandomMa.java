...
//	public String taoMaLK1() {
//		List<String> listLK = new ArrayList<String>();
//		LinhKien_Dao lk = new LinhKien_Dao();
//		List<LinhKien> list = lk.getLinhKien();
//		list.forEach( e-> {
//			listLK.add(e.getMaLinhKien());
//		});
//		int ma;
//		do {
//			java.util.Random random = new java.util.Random();
//			ma = random.nextInt(9999999)+10000000;
//		} while (listLK.contains("LK" + String.valueOf(ma)));
//		return "LK" + String.valueOf(ma);
//	}
//	public  String taoMaHoaDon1() {
//		List<String> listHD = new ArrayList<String>();
//		HoaDon_Dao hd = new HoaDon_Dao();
//		List<HoaDon> list = hd.getHoaDon();
//		list.forEach( e-> {
//			listHD.add(e.getMaHoaDon());
//		});
//		int ma;
//		do {
//			java.util.Random random = new java.util.Random();
//			ma = random.nextInt(9999999)+10000000;
//		} while (listHD.contains("HD" + String.valueOf(ma)));
//		return "HD" + String.valueOf(ma);
//	}
...
//		list.forEach( e-> {
//			listKH.add(e.getMaKhachHang());
//		});
//		int ma;
//		do {
//			java.util.Random random = new java.util.Random();
//			ma = random.nextInt(9999999)+10000000;
//		} while (listKH.contains("KH" + String.valueOf(ma)));
//		return "KH" + String.valueOf(ma);
//	}
