...
public class ThongKe_Dao {
	public List<ChiTietHoaDon> doanhThuTheoNgay(int ngay,int thang,int nam) {
		...
		try {
			PreparedStatement statement = con.prepareStatement("select *from HoaDon join ChiTietHoaDon on HoaDon.maHoaDon = ChiTietHoaDon.maHoaDon join LinhKien on ChiTietHoaDon.maLinhKien = LinhKien.maLinhKien where DAY(ngayDatHang)=? and MONTH(ngayDatHang)=? and YEAR(ngayDatHang)=?");
	...
	public List<ChiTietHoaDon> doanhThuTheoThang(int thang,int nam) {
		...
		Connection con  = new ConnectDB().getConnect();
		try {
			PreparedStatement statement = con.prepareStatement("select *from HoaDon join ChiTietHoaDon on HoaDon.maHoaDon = ChiTietHoaDon.maHoaDon join LinhKien on ChiTietHoaDon.maLinhKien = LinhKien.maLinhKien where MONTH(ngayDatHang)=? and YEAR(ngayDatHang)=?");
	...
	public List<ChiTietHoaDon> doanhThuTheoNam(int nam) {
		...
		Connection con  = new ConnectDB().getConnect();
		try {
			PreparedStatement statement = con.prepareStatement("select *from HoaDon join ChiTietHoaDon on HoaDon.maHoaDon = ChiTietHoaDon.maHoaDon join LinhKien on ChiTietHoaDon.maLinhKien = LinhKien.maLinhKien where YEAR(ngayDatHang)=?");
