	...
	public HoaDonThanhToan_JFrame(HoaDon hoaDon) {
		...
		for (int i = 0; i < listCTHD.size(); i++) {
			...
			model.addRow(new Object[] {
					stt,listCTHD.get(i).getLinhKien().getTenLinhKien(),listCTHD.get(i).getSoLuong(),listCTHD.get(i).getLinhKien().getGiaBan(),listCTHD.get(i).getSoLuong()*listCTHD.get(i).getLinhKien().getGiaBan()
			});
