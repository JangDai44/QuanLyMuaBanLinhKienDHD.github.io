...
public class TrangChu_Panel extends JPanel implements ActionListener {
	/**
	 * 
	 */
	...
	public TrangChu_Panel(NhanVien nhanVien) {
		...
		pLeft.setBackground(SystemColor.controlHighlight);
		...
		lblDanhSchLinh.setFont(new Font("Arial", Font.BOLD, 20));
		...
		btnThemVaoGio.setIcon(new ImageIcon(TrangChu_Panel.class.getResource("/image/add_shopping_cart_30px.png")));
		...
		btnXemThongTin.setIcon(new ImageIcon(TrangChu_Panel.class.getResource("/image/info_30px.png")));
		...
		btnXemThongTin.setBackground(SystemColor.controlDkShadow);
		...
		btnTrangDau.setIcon(new ImageIcon(TrangChu_Panel.class.getResource("/image/skip_to_start_20px.png")));
		...
		btnTrangTruoc.setIcon(new ImageIcon(TrangChu_Panel.class.getResource("/image/rewind_20px.png")));
		...
		btnTrangCuoi.setIcon(new ImageIcon(TrangChu_Panel.class.getResource("/image/end_20px.png")));
		...
		btnTrangSau.setIcon(new ImageIcon(TrangChu_Panel.class.getResource("/image/fast_forward_20px.png")));
		...
		pRight.setBackground(SystemColor.controlHighlight);
		...
		lblDanhSchLinh_1.setFont(new Font("Arial", Font.BOLD, 20));
		...
		btnThanhToan.setIcon(new ImageIcon(TrangChu_Panel.class.getResource("/image/money_bag_30px.png")));
		...
		btnXoa.setIcon(new ImageIcon(TrangChu_Panel.class.getResource("/image/delete_bin_30px.png")));
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (row == -1) {
					...
					if (t == JOptionPane.YES_OPTION) {
						...
						if(Integer.parseInt(txtSoLuong.getText())>Integer.parseInt(table2.getValueAt(row, 2).toString())) {
							for (int i = 0; i < table2.getRowCount(); i++) {
								for (int j = 0; j < table1.getRowCount(); j++) {
									if(table2.getValueAt(i, 0).toString().equals(table1.getValueAt(j, 0).toString())) {
										table1.setValueAt(Integer.parseInt(table1.getValueAt(j, 4).toString())-(Integer.parseInt(txtSoLuong.getText())-Integer.parseInt(table2.getValueAt(i, 2).toString())), j, 4);
									}
								}
							}
						}
						if(Integer.parseInt(txtSoLuong.getText())<Integer.parseInt(table2.getValueAt(row, 2).toString())) {
							for (int i = 0; i < table2.getRowCount(); i++) {
								for (int j = 0; j < table1.getRowCount(); j++) {
									if(table2.getValueAt(i, 0).toString().equals(table1.getValueAt(j, 0).toString())) {
										table1.setValueAt(Integer.parseInt(table1.getValueAt(j, 4).toString())+(Integer.parseInt(table2.getValueAt(i, 2).toString())-Integer.parseInt(txtSoLuong.getText())), j, 4);
									}
								}
							}
						}
		...
		btnSua.setIcon(new ImageIcon(TrangChu_Panel.class.getResource("/image/settings_30px.png")));
		btnSua.setForeground(Color.WHITE);
		btnSua.setFont(new Font("Tahoma", Font.BOLD, 13));
		btnSua.setFocusTraversalKeysEnabled(false);
		btnSua.setFocusPainted(false);
		btnSua.setBorder(null);
		btnSua.setBackground(new Color(65, 105, 225));
		...
		btnTaoMoi.setIcon(new ImageIcon(TrangChu_Panel.class.getResource("/image/create_30px.png")));
					...
					if (khachTra1.length() == 0) {
						...
						if (!khachTra1.matches("[0-9]+")) {
							...
							if (n > 0) {
								...
								txtThoiLai.setText(String.valueOf(df.format(khachTra - tinhTongTien())));
							} else {
								JOptionPane.showMessageDialog(null, "Bạn phải mua hàng trước khi thanh toán");
							}
						}
					}
		...
		txtThoiLai = new JTextField();
		txtThoiLai.setEditable(false);
		txtThoiLai.setColumns(10);
		txtThoiLai.setBounds(86, 93, 96, 23);
		panel_3.add(txtThoiLai);
		...
		JLabel lblNewLabel_2_5_2 = new JLabel("VNĐ");
		lblNewLabel_2_5_2.setForeground(Color.RED);
		lblNewLabel_2_5_2.setFont(new Font("Arial", Font.BOLD, 13));
		lblNewLabel_2_5_2.setBounds(185, 93, 36, 23);
		...
		btnNewButton_3.setIcon(new ImageIcon(TrangChu_Panel.class.getResource("/image/calendar_25px.png")));
		...
		btnNewButton_3_1.setIcon(new ImageIcon(TrangChu_Panel.class.getResource("/image/calendar_25px.png")));
		...
		btnNewButton_3_1_1.setIcon(new ImageIcon(TrangChu_Panel.class.getResource("/image/calendar_25px.png")));
		...
		b.setBackground(new Color(72, 61, 139));
		...
		btnNewButton.setIcon(new ImageIcon(TrangChu_Panel.class.getResource("/image/minus_18px.png")));
		...
		btnNewButton_1.setIcon(new ImageIcon(TrangChu_Panel.class.getResource("/image/plus_18px.png")));
	...
	public void XoaKhoiGio() {
		...
		if (row == -1) {
			JOptionPane.showMessageDialog(this, "Phải chọn dòng cần xóa khỏi vỏ ! ");
		} else {
