...
//	private ArrayList<JPanel> listButon;
	...
	public ManHinhNhanVien_JFrame(NhanVien nhanVien) {
		...
		lblNewLabel.setIcon(new ImageIcon(ManHinhNhanVien_JFrame.class.getResource("/image/logo.png")));
		...
		lblLinhKien.setIcon(new ImageIcon(ManHinhNhanVien_JFrame.class.getResource("/image/multiple_devices_30px.png")));
		...
		lblDangXuat.setIcon(new ImageIcon(ManHinhNhanVien_JFrame.class.getResource("/image/logout_rounded_left_30px.png")));
		...
		lblHDSD.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				//try {
					//Runtime.getRuntime().exec("hh.exe \"HDSDNV.chm\"");
					//lblHDSD. (ManHinhNhanVien_JFrame.class.getResource("/doc/HDSDNV.chm"));
					//Runtime.getRuntime().exec(ManHinhNhanVien_JFrame.class.getResource("hh.exe /doc/HDSDNV.chm"));
				//} catch (IOException e1) {
					// TODO Auto-generated catch block
				//	e1.printStackTrace();
				//}
