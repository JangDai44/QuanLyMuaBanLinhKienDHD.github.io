...
public class NhanVien_QL_JPanel extends JPanel {
	...
	public NhanVien_QL_JPanel() {
		...
		lblMNhnVin.setFont(new Font("Arial", Font.PLAIN, 13));
		...
		lblMNhnVin_1_2.setFont(new Font("Arial", Font.PLAIN, 13));
		...
		lblMNhnVin_1_2_1.setFont(new Font("Arial", Font.PLAIN, 13));
		...
		panel_4.setBounds(10, 288, 1006, 295);
		panel.add(panel_4);
		...
		scrollPane.setBounds(10, 22, 986, 263);
