...
public class LinhKien_JPanel extends JPanel {
	...
	public LinhKien_JPanel() {
		...
		String row[] = { "Mã Linh Kiện", "Tên Linh Kiện", "Số Lượng Tồn", "Thương Hiệu", "Loại Linh Kiện",
	...
	public boolean thongTinLK() {
		...
		try {
			...
			if (baoHanh < 0) {
				JOptionPane.showMessageDialog(null, "Bảo hành phải lớn hơn 0 !");
			...
			JOptionPane.showMessageDialog(null, "Bảo hành phải là số nguyên và không được để trống !");
			txtBaoHanh.selectAll();
			;
			txtBaoHanh.requestFocus();
			return false;
