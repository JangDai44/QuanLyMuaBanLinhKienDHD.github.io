...
public class NhanVien_BH_JPanel extends JPanel {
	...
	public NhanVien_BH_JPanel() {
		...
		lblThngTinNhn.setFont(new Font("Arial", Font.BOLD, 20));
		lblThngTinNhn.setBounds(322, 10, 441, 35);
		panel_1.add(lblThngTinNhn);
		
		JPanel panel_3 = new JPanel();
		panel_3.setLayout(null);
		panel_3.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)), "Th\u00F4ng Tin Nh\u00E2n Vi\u00EAn", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		panel_3.setBounds(10, 65, 1006, 160);
		panel.add(panel_3);
		
		JLabel lblTnNhnVin = new JLabel("Tên nhân viên :");
		lblTnNhnVin.setFont(new Font("Arial", Font.PLAIN, 13));
		...
		lblChcV.setFont(new Font("Arial", Font.PLAIN, 13));
		lblChcV.setBounds(533, 35, 94, 25);
		panel_3.add(lblChcV);
		
		JLabel lblMNhnVin_1_1 = new JLabel("Giới tính :");
		lblMNhnVin_1_1.setFont(new Font("Arial", Font.PLAIN, 13));
		...
		lblMNhnVin_1_3.setFont(new Font("Arial", Font.PLAIN, 13));
		...
		lblMNhnVin_1_4.setFont(new Font("Arial", Font.PLAIN, 13));
	...
	public void docDL() {
		...
		list.forEach(e -> {
			...
			model.addRow(new Object[] {
					e.getTenNhanVien(),e.getChucVu(),gt,e.getsDT(),e.getDiaChi()
			});
		});
	}
}
